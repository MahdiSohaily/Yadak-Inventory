$(document).ready(function () {
    ...
    $(".price-page table").on("click", ".Save", function () {
        ...
        url = 'https://api.telegram.org/bot1681398960:AAGykdRX-71G0PcK2X_yf3uVQOFWKVNMxoc/sendMessage?chat_id=-522041592&text=' + $(this).attr("msg");

        $.get(url, // url
            function (data, textStatus, jqXHR) {

                if (textStatus == "success")
                    $(".Save").removeClass("msg-loading");
            });
