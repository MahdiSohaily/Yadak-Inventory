...
SELECT nisha.partnumber ,brand.id AS brnid, brand.name , qtybank.des , qtybank.qty , qtybank.id , qtybank.pos1 ,qtybank.invoice_date, qtybank.pos2 , qtybank.create_time , seller.name AS sln, deliverer.name AS dn ,deliverer.id AS dlid , qtybank.anbarenter ,qtybank.invoice , users.username AS un , qtybank.invoice_number ,stock.name AS stn,stock.id AS stid
FROM qtybank
    ...
    <form id="vorod-edit" method="get" action="vorodkala-report-edit-save.php" autocomplete="off">
        ...
        <div class="right-form">
            ...
            <fieldset>
                ...
                <input type="radio" name="invoice" id="invoice" value="0" <?php if($row["invoice"]==0){echo "checked";} ?>>
                <label for="nvoice">بله</label>
                <input type="radio" name="invoice" id="invoice" value="1" <?php if($row["invoice"]==1){echo "checked";} ?>>
            </fieldset>
            ...
            <fieldset>
                ...
                <input type="radio" name="anbarenter" id="anbarenter" value="0" <?php if($row["anbarenter"]==0){echo "checked";} ?>>

                <label for="anbarenter">بله</label>
                <input type="radio" name="anbarenter" id="anbarenter" value="1" <?php if($row["anbarenter"]==1){echo "checked";} ?>>
