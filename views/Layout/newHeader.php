...
<head>
    ...
    <style>
        @font-face {
            font-family: "SDF";
            src: url("../../../callcenter/report/public/fonts/IRANSans-Light-web.woff") format("woff"),
                url("../../../callcenter/report/public/fonts/IRANSans-Light-web.ttf") format("truetype");
            font-weight: normal;
        }
        ...
        @font-face {
            ...
            src: url("../../../callcenter/report/public/fonts/IRANSans-Bold-web.woff") format("woff"),
                url("../../../callcenter/report/public/fonts/IRANSans-Bold-web.ttf") format("truetype");
            font-weight: bold;
        }
...
<body style="padding-block: 70px" class="rtl">
    <nav id="main_nav">
